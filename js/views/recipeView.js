...
export const updateServingsUI = (ingredients,servings) => {
    ...
    arr.forEach((el,index)=>{
        el.textContent = formatCount(ingredients[index].count);
    });
};
...
const renderingredient = ingr => `
            <li class="recipe__item">
                ...
                <div class="recipe__count">${formatCount(ingr.count)}</div>
